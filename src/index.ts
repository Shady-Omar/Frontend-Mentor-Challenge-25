...
function appendData(data) {
  let activity:any = document.querySelector("#activity");
...
let daily:any = document.querySelector("#daily");

daily.addEventListener('click', () => {
  let day:any = document.getElementsByClassName("daily");
  let week:any = document.getElementsByClassName("weekly");
  let month:any = document.getElementsByClassName("monthly");
...
let weekly:any = document.querySelector("#weekly");
...
let monthly:any = document.querySelector("#monthly");
